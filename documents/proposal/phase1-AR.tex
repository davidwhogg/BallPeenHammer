...
\texttt{flt} files which have had no flat applied.  Our model for the
patch is 
...
(flux located at a delta function in space for stars, surface
brightness distribution for galaxies) convolved with the pixelated
PSF.  The convolved scene is mulitiplied by the pixelated flat field
